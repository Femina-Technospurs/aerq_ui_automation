...
Scenario Outline: Add date to ground permit and create new match
	...
	##@externaldata@./src/test/resources/data/TestData_LiveScore_Parallel_2.xlsx@Admin
...
And Wait for the "IEmail Acknowledged by Opponent" Status of Match "<Match_ID>" Util enable
And Select the Match "<Match_ID>" And Expand it
And Update Home Team Members "<Match_ID>" "<Captain>" "<WicketKeeper>"
And Select the Match "<Match_ID>" And Expand it
...
Then Wait for the "Umpire assigned by Team 2" Status of Match "<Match_ID>" Util enable
...
And Select live match from home "<Match_ID>"
And Add run to the live match "6"
And Select the next player "Jainish Mistry" and Wicket by "Rajesh Borkar" "Obstructing the field"
And Select live match from home "<Match_ID>"
And Add run to the live match "6"
And Select the Final player and Wicket by "Rajesh Borkar" "Retired Out"
And Select live match from home "<Match_ID>"
And End Innings by Home Team "<Home_Team>"
And Navigate to the cricbay url
And Click on Logout

Examples:
      | Testcase_NO | Scenario | Match_ID |Skriker |	NonStriker	| Bowler	| Player	| Fielder	| Dismissal | Win	| POM | Captain	| WicketKeeper |Home_Team	| Away_Team |
	##@externaldata@./src/test/resources/data/TestData_LiveScore_Parallel_2.xlsx@Home
|Testcase_005|Ack|26673|Abhishek Dhanuka|Jainish Mistry|Rajesh Borkar|Anil Kaneriya|Akash Devgun|Bowled|Alp Won|Abhishek Dhanuka (Absol)|Ankit Solanki|Abhishek Dhanuka|Absolute|Alpha Lions|
...
And Select the Match "<Match_ID>" And Expand it
And Update Away Team Members "<Match_ID>" "<AwayCaptain>" "<AwayWicketKeeper>"
And Select the Match "<Match_ID>" And Expand it
And Verify the "Playing XI Entered" Status of Match "<Match_ID>"
And Click on Logout
...
Examples:
      | Testcase_NO | Scenario | Match_ID | Skriker |	NonStriker | Bowler | Player	| Fielder	 | Dismissal | WicketKeeper | Win	| POM | AwayCaptain	| AwayWicketKeeper|     
	##@externaldata@./src/test/resources/data/TestData_LiveScore_Parallel_2.xlsx@Away
|Testcase_005|Ack|26673|Abhishek Misra|Nikhil Jain|Jainish Mistry|Akash Devgun|Akshya QA |Retired Out|Akash Devgun|Alp Won|Abhishek Dhanuka (Absol)|Mohit Goenka|Nikhil Jain|

@away2
Scenario Outline: Away Team Add Run and Close Match
Given Open the chrome
And Navigate to the cricbay url
#And Click login link
When Login as Away Team
Then Wait for the "Innings Completed" Status of Match "<Match_ID>" Util enable
And Select live match from home "<Match_ID>"
...
And Select live match from home "<Match_ID>"
And End Innings by Ops Team "<Away_Team>"
And Navigate to the cricbay url
#And Select the Match "<Match_ID>" And Expand it
...
Examples:
      | Testcase_NO | Scenario | Match_ID | Skriker |	NonStriker | Bowler | Player	| Fielder	 | Dismissal | WicketKeeper | Win	| POM | Home_Team	| Away_Team |  
  	##@externaldata@./src/test/resources/data/TestData_LiveScore_Parallel_2.xlsx@Away2
|Testcase_005|Ack|26673|Abhishek Misra|Nikhil Jain|Jainish Mistry|Akash Devgun|Akshya QA |Retired Out|Akash Devgun|Alp Won|Abhishek Dhanuka (Absol)|Absolute|Alpha Lions|
...
Examples:
	...
	##@externaldata@./src/test/resources/data/TestData_LiveScore_Parallel_2.xlsx@HomeUmpire
...
Examples:
	...
	##@externaldata@./src/test/resources/data/TestData_LiveScore_Parallel_2.xlsx@AwayUmpire
